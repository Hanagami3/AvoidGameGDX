package be.hanagami.obstacleAvoid.util.debug;
...
public class DebugCameraConfig {
    ...
    private void init() {
        ...
        if (fileHandle.exists()) {
            ...
            log.info("Using default file does not exist= " + FILE_PATH);
            setUpDefaults();
        }
    }
    ...
    private void load() {
        try {
            ...
            rightKey = getInputKeyValue(root, RIGHT_KEY, DEFAULT_RESET_KEY);
            ...
            logKey = getInputKeyValue(root, LOG_KEY, DEFAULT_LEFT_KEY);
